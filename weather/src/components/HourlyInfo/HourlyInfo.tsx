            ...
            <div className={'hourly_info'}>
                ...
                {[0, 4, 8, 12, 16, 20].map((item) =>
                    <div className={'hourly_info__item'} key={item}>
                        <div className={'hourly_info__item__hours'}>{item}:00</div>
                        <WeatherIcons id={weather?.forecast.forecastday[0].hour[item].condition.text
                        && conditionsWeather.has(weather.forecast.forecastday[0].hour[item].condition.text)
                            ? conditionsWeather.get(weather.forecast.forecastday[0].hour[item].condition.text)!
                            : 'sunny'} width={50} />
                        ...
                        <img src={navigationImg} style={{
                            width: '35px',
                            rotate: `${weather?.forecast.forecastday[0].hour[item].wind_degree
                                ? weather.forecast.forecastday[0].hour[item].wind_degree
                                : 0}deg`,
                        }} />
                        <div className={'hourly_info__item__wind_speed'}>
                            {weather?.forecast.forecastday[0].hour[item].wind_kph
                                ? weather.forecast.forecastday[0].hour[item].wind_kph
                                : '-'}км/ч
                        </div>
                    </div>,
